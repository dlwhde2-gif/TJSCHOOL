    ...
    <SubPageLayout mainCategory={mainCategory} subCategory={subCategory} navItems={navItems}>
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 mb-12">
          <p className="text-gray-500 font-medium">총 <span className="text-primary font-bold">{posts.length}</span>건의 게시물이 있습니다.</p>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b-2 border-gray-800 text-gray-800 bg-gray-50">
                ...
                <th className="px-6 py-5 text-left font-bold">제목</th>
                <th className="px-6 py-5 text-center font-bold w-28">작성자</th>
                <th className="px-6 py-5 text-center font-bold w-32">작성일</th>
                <th className="px-6 py-5 text-center font-bold w-24">조회수</th>
              </tr>
            </thead>
